    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLanguages", x => new { x.IdUser, x.Language });
                    table.ForeignKey(
                        name: "FK_UserLanguages_Users_IdUser",
                        column: x => x.IdUser,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesFiles", x => new { x.CourseId, x.FileId });
                    table.ForeignKey(
                        name: "FK_CoursesFiles_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId");
                    table.ForeignKey(
                        name: "FK_CoursesFiles_Files_FileId",
                        column: x => x.FileId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileAccesses", x => x.AccessId);
                    table.ForeignKey(
                        ...
                        principalColumn: "FileId");
                    table.ForeignKey(
                        name: "FK_FileAccesses_Users_IdUser",
                        column: x => x.IdUser,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostsFiles", x => new { x.FileId, x.PostId });
                    table.ForeignKey(
                        name: "FK_PostsFiles_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "FileId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostsFiles_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "PostId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentMedia", x => new { x.CommentId, x.FileId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CommentMedia_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "FileId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileAccesses_IdFile",
                table: "FileAccesses",
                column: "IdFile");

            migrationBuilder.CreateIndex(
                name: "IX_FileAccesses_IdUser",
                table: "FileAccesses",
                column: "IdUser");
